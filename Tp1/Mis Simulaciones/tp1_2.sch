...
* Simulation
.control
  dc VDS -1.8 1.8 0.01 VGS -1.8 1.8 0.3 
  setplot dc1
  plot @M.XM1.msky130_fd_pr__nfet_01v8[id] @M.XM2.msky130_fd_pr__pfet_01v8[id] ylabel Id xlabel Vds title 'Id vs Vds vs Vgs' 
  set filetype = ascii
  ...
  dc VGS -1.8 1.8 0.01
  setplot dc2
  plot @M.XM1.msky130_fd_pr__nfet_01v8[id] @M.XM2.msky130_fd_pr__pfet_01v8[id] ylabel Id xlabel Vgs title 'Id vs Vgs (escala lineal)'
