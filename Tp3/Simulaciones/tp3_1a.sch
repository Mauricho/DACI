...
.control
  ...
  *dowhile wi <= wf
    *print @M.XM0.msky130_fd_pr__nfet_01v8_lvt[w]
    *alter @M.XM0.msky130_fd_pr__nfet_01v8_lvt[w] = wi
    *alter @M.XM1.msky130_fd_pr__nfet_01v8_lvt[w] = wi
    *let wi = wi + wstep
    *op
    *print @M.XM0.msky130_fd_pr__nfet_01v8_lvt[w]
    *print @M.XM0.msky130_fd_pr__nfet_01v8_lvt[vth]
    *print @M.XM1.msky130_fd_pr__nfet_01v8_lvt[w]
    *print @M.XM1.msky130_fd_pr__nfet_01v8_lvt[id]
    *print @M.XM1.msky130_fd_pr__nfet_01v8_lvt[vth]
    *print @M.XM2.msky130_fd_pr__nfet_01v8_lvt[w]
    ...
    *print @M.XM3.msky130_fd_pr__nfet_01v8_lvt[w]
    *print @M.XM3.msky130_fd_pr__nfet_01v8_lvt[vdsat]
    *print @M.XM3.msky130_fd_pr__nfet_01v8_lvt[gds]
...
descr="vth="}
C {ngspice_get_value.sym} 2320 -970 0 0 {name=r11 node=v(@M.XM2.msky130_fd_pr__nfet_01v8_lvt[vth])
descr="vth="}
...
descr="vdsat="}
C {ngspice_get_value.sym} 2660 -1090 0 0 {name=r15 node=i(@M.XM3.msky130_fd_pr__nfet_01v8_lvt[id])
descr="Id="}
C {ngspice_get_value.sym} 2660 -1130 0 0 {name=r16 node=@M.XM3.msky130_fd_pr__nfet_01v8_lvt[gm]
descr="gm="}
C {ngspice_get_value.sym} 2660 -1180 0 0 {name=r17 node=@M.XM3.msky130_fd_pr__nfet_01v8_lvt[gds]
descr="gds="}
C {ngspice_get_value.sym} 2660 -1220 0 0 {name=r18 node=v(@M.XM3.msky130_fd_pr__nfet_01v8_lvt[vdsat])
descr="vdsat="}
C {ngspice_get_value.sym} 2610 -850 0 0 {name=r19 node=v(@M.XM1.msky130_fd_pr__nfet_01v8_lvt[vth])
descr="vth="}
