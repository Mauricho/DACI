...
descr="vds="}
C {ngspice_get_value.sym} 2650 -1180 0 0 {name=r23 node=i(@M.XM9.msky130_fd_pr__pfet_01v8_lvt[id])
descr="Id="}
C {ngspice_get_value.sym} 2370 -1180 0 0 {name=r22 node=i(@M.XM10.msky130_fd_pr__pfet_01v8_lvt[id])
descr="Id="}
