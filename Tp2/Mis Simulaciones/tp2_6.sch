...
N 2520 -1110 2530 -1110 {
lab=vdd}
N 2520 -1160 2520 -1110 {
lab=vdd}
N 2520 -1160 2530 -1160 {
lab=vdd}
N 2570 -1110 2600 -1110 {
lab=vout}
N 2600 -1110 2600 -1060 {
lab=vout}
N 2530 -1060 2600 -1060 {
lab=vout}
...
descr="Vth="}
C {sky130_fd_pr/pfet_01v8_lvt.sym} 2550 -1110 0 1 {name=M2
L=0.35
W=\{wp\}
nf=1
mult=1
...
C {ngspice_get_value.sym} 2550 -1180 0 0 {name=r9 node=v(@M.XM2.msky130_fd_pr__pfet_01v8_lvt[vdsat])
descr="Vdsat="}
C {ngspice_get_value.sym} 2550 -1150 0 0 {name=r10 node=@M.XM2.msky130_fd_pr__pfet_01v8_lvt[gm]
descr="gm="}
C {ngspice_get_value.sym} 2620 -1150 0 0 {name=r11 node=@M.XM2.msky130_fd_pr__pfet_01v8_lvt[gds]
descr="gds="}
C {ngspice_get_value.sym} 2620 -1180 0 0 {name=r12 node=v(@M.XM2.msky130_fd_pr__pfet_01v8_lvt[vth])
descr="Vth="}
