...
C {ngspice_get_value.sym} 2000 -70 0 0 {name=r1 node=v(@M.X1.XM6.msky130_fd_pr__nfet_01v8[vth])
descr="Vth= "}
C {ngspice_get_value.sym} 1510 -410 0 0 {name=r7 node=v(@M.X1.XM5.msky130_fd_pr__pfet_01v8[vdsat])
descr="vdsat= "}
C {ngspice_get_value.sym} 1500 -120 0 0 {name=r24 node=@M.X1.XM4.msky130_fd_pr__nfet_01v8[gds]
descr="gds= "}
C {ngspice_get_value.sym} 2000 -110 0 0 {name=r26 node=@M.X1.XM6.msky130_fd_pr__nfet_01v8[gds]
descr="gds= "}
C {ngspice_get_value.sym} 1970 -370 0 0 {name=r27 node=@M.X1.XM7.msky130_fd_pr__pfet_01v8[gds]
descr="gds= "}
C {ngspice_get_value.sym} 1510 -380 0 0 {name=r28 node=@M.X1.XM5.msky130_fd_pr__pfet_01v8[gds]
descr="gds= "}
C {ngspice_get_value.sym} 1090 -410 0 0 {name=r29 node=@M.X1.XM8.msky130_fd_pr__pfet_01v8[gds]
descr="gds= "}
C {ngspice_get_expr.sym} 1290 -210 0 0 {name=r30 node="[format %.4g [expr 1 / [ngspice::get_node \{@M.X1.XM1.msky130_fd_pr__pfet_01v8_lvt[gds]\}] ] ]"
descr="Ro="}
C {ngspice_get_expr.sym} 1570 -210 0 0 {name=r31 node="[format %.4g [expr 1 / [ngspice::get_node \{@M.X1.XM2.msky130_fd_pr__pfet_01v8_lvt[gds]\}] ] ]"
descr="Ro="}
C {ngspice_get_value.sym} 1290 -10 0 0 {name=r23 node=@M.X1.XM3.msky130_fd_pr__nfet_01v8[gds]
descr="gds= "}
C {ngspice_get_expr.sym} 1290 30 0 0 {name=r32 node="[format %.4g [expr 1 / [ngspice::get_node \{@M.X1.XM3.msky130_fd_pr__nfet_01v8[gds]\}] ] ]"
descr="Ro="}
C {ngspice_get_expr.sym} 1570 30 0 0 {name=r33 node="[format %.4g [expr 1 / [ngspice::get_node \{@M.X1.XM4.msky130_fd_pr__nfet_01v8[gds]\}] ] ]"
descr="Ro="}
C {ngspice_get_expr.sym} 1890 10 0 0 {name=r34 node="[format %.4g [expr 1 / [ngspice::get_node \{@M.X1.XM6.msky130_fd_pr__nfet_01v8[gds]\}] ] ]"
descr="Ro="}
C {ngspice_get_expr.sym} 1970 -340 0 0 {name=r35 node="[format %.4g [expr 1 / [ngspice::get_node \{@M.X1.XM7.msky130_fd_pr__pfet_01v8[gds]\}] ] ]"
descr="Ro="}
C {ngspice_get_expr.sym} 1090 -470 0 0 {name=r37 node="[format %.4g [expr 1 / [ngspice::get_node \{@M.X1.XM8.msky130_fd_pr__pfet_01v8[gds]\}] ] ]"
descr="Ro="}
C {ngspice_get_expr.sym} 1510 -470 0 0 {name=r36 node="[format %.4g [expr 1 / [ngspice::get_node \{@M.X1.XM5.msky130_fd_pr__pfet_01v8[gds]\}] ] ]"
descr="Ro="}
