...
C {vsource.sym} 800 -200 0 0 {name=V4 value="sin(0 \{vac\} \{fin\}) dc 0 ac 1"}
...
C {lab_pin.sym} 1250 -280 2 0 {name=l8 sig_type=std_logic lab=vss}
C {ngspice_probe.sym} 1030 -360 0 0 {name=r1}
C {ngspice_probe.sym} 800 -250 0 0 {name=r2}
C {ngspice_probe.sym} 1390 -340 0 0 {name=r3}
C {ngspice_probe.sym} 1210 -250 0 0 {name=r4}
C {ngspice_probe.sym} 1110 -270 0 0 {name=r5}
